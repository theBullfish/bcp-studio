...
namespace via the parent include in studio/urls.py.

Static `shop/...` routes MUST precede the `shop/<slug>` catch-all, or paths
like /shop/success/ get captured as a client slug.
"""
...
urlpatterns = [
    # Public storefront (static routes first)
